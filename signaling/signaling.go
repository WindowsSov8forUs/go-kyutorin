...
const (
	SignalingEvent    SignalingType = iota // 事件
	SignalingPing                          // 心跳
	SignalingPong                          // 心跳回复
	SignalingIdentify                      // 鉴权
	SignalingReady                         // 鉴权回复
)
...
const (
	...
	EventTypeGuildRoleAdded   EventType = "guild-role-added"   // 群组角色被创建时触发
	EventTypeGuildRoleUpdated EventType = "guild-role-updated" // 群组角色被修改时触发
	EventTypeGuildRoleRemoved EventType = "guild-role-removed" // 群组角色被删除时触发
